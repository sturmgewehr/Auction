...
namespace Data_Access_Layer.Initializer
{
    public class DbInitializer : DropCreateDatabaseAlways<AppContext>
    {
        protected override void Seed(AppContext context)
        {
            ...
            User u1 = new User { Login = "abc123", Password = "qwe123", Profile = p1 };
            //---USER 2
            ...
            User u2 = new User { Login = "sam111", Password = "passwd", Profile = p2 };
            //---USER 3
            ...
            User u3 = new User { Login = "fusroda", Password = "skyrim", Profile = p3 };
